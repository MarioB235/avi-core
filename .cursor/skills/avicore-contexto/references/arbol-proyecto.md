...
├── scripts/                  # dev.php, write-build-meta.cjs, check-agent-docs-sync, check-docs-impact, check-cloud-readiness, check-skill-references, …
