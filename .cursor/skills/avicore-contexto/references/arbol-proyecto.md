...
└── js/                       # `app.js`, `pwa-install.js` (`__avicorePwaInstall`), `pwa.js` (SW + snackbar update), `operario-navigate.js`
```
