...
- Servicios operarios con reglas de negocio (`OperarioGalponService`: maples, multiempresa, galpón disponible): tests Feature en `tests/Feature/Services/OperarioGalponServiceTest.php` + integración en `tests/Feature/Ui/` cuando aplique.
