...
- PWA (`x-ui.pwa-meta`, `x-ui.pwa-install-prompt`): `tests/Feature/Ui/PwaInstallPromptTest.php` (manifest + banner en login/operario/admin; split `enabled` vs `install_prompt`; `shouldShowBanner`; `apple-touch-icon` + `pwa-192`).
