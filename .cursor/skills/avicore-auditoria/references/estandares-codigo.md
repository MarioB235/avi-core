...
- Menú cuenta operario (`x-operario.user-menu`): `tests/Feature/Ui/OperarioUserMenuTest.php` (portal/teleport, `syncPanelPosition`, clamp `panelHeight`/`max-height`, Perfil + logout).
