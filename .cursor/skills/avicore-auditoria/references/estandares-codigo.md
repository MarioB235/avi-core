...
- Flujos de auth (`AttemptLoginAction`, `DemoLoginService::resolveUser`, Livewire `Login`): tests Feature en `tests/Feature/Auth/` / `tests/Feature/Services/` y render en `tests/Feature/Ui/LoginViewTest.php`.
