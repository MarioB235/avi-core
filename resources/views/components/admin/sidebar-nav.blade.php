...
<aside class="avicore-operario-sidebar hidden lg:flex" aria-label="Navegación panel">
    <div class="avicore-operario-sidebar__brand">
        <x-ui.logo :subtitle="\App\Support\AdminNav::sidebarSubtitle()" theme="on-primary" class="min-w-0 flex-1" />
    </div>

    <p class="avicore-operario-sidebar__section-label">Navegación</p>

    <nav class="avicore-operario-sidebar__nav" aria-label="Secciones del panel">
        @foreach ($tabs as $tab)
